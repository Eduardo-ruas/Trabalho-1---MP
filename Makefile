all: testa_velha.cpp   velha.cpp velha.hpp velha.o
	g++ -std=c++14 -Wall velha.o testa_velha.cpp -o testa_velha
	./testa_velha
...
gcov: testa_velha.cpp   velha.cpp velha.hpp 
	...
	g++ -std=c++14 -Wall -fprofile-arcs -ftest-coverage velha.o testa_velha.cpp -o testa_velha
	./testa_velha
	gcov *.cpp	
	 
debug: testa_velha.cpp   velha.cpp velha.hpp 
	g++ -std=c++14 -Wall -g -c velha.cpp
	g++ -std=c++14 -Wall  -g velha.o testa_velha.cpp -o testa_velha
	gdb testa_velha
